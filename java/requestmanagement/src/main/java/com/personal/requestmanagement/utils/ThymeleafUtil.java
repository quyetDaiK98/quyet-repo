...
public class ThymeleafUtil {
	...
	public static void errorMessage(Model model) {
		model.addAttribute("message",
				new Gson().toJson(new Message(CommonConst.ERROR_ACTION_CODE, CommonConst.ERROR_ACTION_MESS)));
	}
	...
	public static void successMessage(Model model) {
		model.addAttribute("message",
				new Gson().toJson(new Message(CommonConst.SUCCESS_ACTION_CODE, CommonConst.SUCCESS_ACTION_MESS)));
	}
