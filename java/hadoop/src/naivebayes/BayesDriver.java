...
public class BayesDriver {
	...
	public static void main(String[] args) {
		...
		JobConf job_conf = new JobConf(BayesDriver.class);
		...
		job_conf.setMapperClass(BayesMapper.class);
		job_conf.setReducerClass(BayesReducer.class);
